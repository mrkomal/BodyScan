class ExcelHandlerForMeasurements extends ExcelHandler {
 
  //Input calibration properties
  private final static String PATH_TO_CALIBRATION_NUMBERS = "C:/Users/admin/Desktop/praktyki/measurement_numbers.xlsx";
  ...
  private final static String PATH_TO_CALIBRATION = "C:/Users/admin/Desktop/praktyki/measurements.xlsx";
  ...
  public ExcelHandlerForMeasurements(ArrayList<String> distances) {
  ...
  private void saveData() {
    ...
    System.out.println("Values are now in Excel!");
